...
# Philips API Response Keys
PHILIPS_ALLERGEN_INDEX = 'iaql'
PHILIPS_BRIGHTNESS = 'aqil'
...
SPEED_LIST = [SPEED_1, SPEED_2, SPEED_3, SPEED_TURBO]
SPEED_MAP = {
...
MODE_NIGHT = 'Night'
MODE_LIST = [MODE_AUTO, MODE_ALLERGEN, MODE_SLEEP,
             MODE_MANUAL, MODE_BACTERIA, MODE_NIGHT]
...
SPEED_AND_MODE_LIST = [MODE_AUTO, MODE_ALLERGEN,
...
FUNCTION_LIST = [FUNCTION_PURIFICATION, FUNCTION_BOTH]
FUNCTION_MAP = {
